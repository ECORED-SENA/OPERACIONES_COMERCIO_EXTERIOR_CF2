  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 De acuerdo con los conceptos emitidos acerca a los medios y modos de transporte, relacione las letras en las casillas que corresponda a la definición citada y luego haga clic en el botón Enviar para validar su resultado.
