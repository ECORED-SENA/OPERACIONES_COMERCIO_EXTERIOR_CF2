...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p Finalmente, una vez se tengan identificados los medios y modos de transporte, se deben contemplar medidas que permitan un sistema de transporte intermodal, donde se realiza la identificación de centros industriales, puertos y fronteras; cadenas logísticas para transporte; localización de puntos estratégicos para intercambio modal de la mercancía o carga.
    ...
    .row.align-items-center.mb-5
      .col-lg-7
        .cajon-b.color-primario.p-4.mb-4
          p.mb-0 Para diseñar, optimizar y planificar las rutas de transporte se debe conocer de primera mano el tipo de carga, vehículo, área y concurrencia de tráfico al destino del producto; intervienen varios elementos, el principal es la tecnología; un software que cubra todas las necesidades requeridas durante el proceso, reduce tiempos de trayecto, desgaste de los vehículos y mejora entregas a clientes, lo que se refleja en un servicio al cliente.
        p Todo esto se puede alcanzar observando la información donde se encuentran los productos a despachar, clientes a servir y agradar, cantidades de carga transportada, entre otros.
        p Al elaborar un plan de ruta, los administradores pueden verse en dificultades en el proceso de las variables que se deben tener en cuenta, impidiendo su efectividad, operatividad y comercialización. Esto lleva a un desafío aún mayor para los planificadores de los manuales de ruta, evitando la proyección real de estas variables. Algunos ejemplos de esto son:
      .col-lg-5
    ...
    ul.lista-ul
      li 
        ...
        | Servicios del agente de carga que no incrementen los costos de transportación. 
      li 
        i.fas.fa-check.cs.ms-4
      ...
      li 
        i.fas.fa-check.cs.ms-4
        | Que se mantengan actualizados en legislación aduanera, tributación, certificaciones y medios de transporte, rutas, tarifas y líneas. 
      li 
        i.fas.fa-check.cs.ms-4
    ...
    .row
      ...
      .col-lg-7
        .cajon-b.color-primario.p-4
          p Los agentes de carga en cualquier modalidad, ofrecen soluciones integrales para resolver problemas logísticos y de transporte.
        p La principal función de los agentes de carga es brindar soluciones integrales de logística y de transporte a las empresas, de forma que solo se preocupan por cumplir lo que mejor saben hacer, sus productos y/o servicios.
        a.anexo.mb-4(href="https://www.asonav.org/documentos/" target="_blank")
          .anexo__icono
